...
public class PersistentModelEvent extends ApplicationEvent {
    ...
    public PersistentModelEvent(Type type, AbstractMainModel... models/*对于POST_UPDATE, 会有2个Model*/) {
        // TODO 是否要做一个长度校验??
    ...
    public AbstractMainModel getModel() {
        return (AbstractMainModel) getModels()[0];
    }

    public AbstractMainModel[] getModels() {
        return (AbstractMainModel[]) getSource();
    }
